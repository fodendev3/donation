                ...
                <div className="flex border-b-4 drop-shadow-lg justify-between">
                    ...
                    <div className='flex justify-center items-center'>
                        <ul className='flex'>
                            ...
                            <li className='mx-4 -my-2 font-semibold hover:underline cursor-pointer'>Partners</li>
                            <li className='mx-4 -my-2 font-semibold hover:underline cursor-pointer'>Testimonials</li>
                            <li className='mx-4 -my-2 font-semibold hover:underline cursor-pointer'>Register &gt;</li>
                        </ul>
                    </div>
                </div>
            </div>
